...
The data are offset common image gathers generated by Kirchhoff depth migration. Fréchet derivatives are calculated by dynamic ray tracing and a conjugate gradient method with constraints is used to solve the linear least square problem. Examples of dynamic ray tracing and estimation of dip/azimuth using structure tensors are shown below.
